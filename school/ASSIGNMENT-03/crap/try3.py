...
def get_options():
    kwargs = {}
    options = ['hf:n:123', ['help', 'file=', 'cards=']]
...
-f --file=[FILE]  Specify file containing deck information.
-c --cards=[N]    Specify number of cards placed on the table in war.
-1 -2 -3          Aliases for -c1 -c2 -c3.
