...
class Maze:
    ...
    def analyze_wall_data(self, dir1, dir2, STRING, size):
        ...
        print(self.__size, size, len(data))
        print(len(dir1),len(dir2))
        for x in range(0, 2):
            buf = []
            for y in range(0, len(dir1)):
                if x < self.__size[0] and y < self.__size[1]:
