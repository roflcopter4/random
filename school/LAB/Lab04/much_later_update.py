...
class Maze:
    ...
    def analyze_wall_data(self, dir1, dir2, STRING, size):
        ...
        LINE = [STRING]*size
        data = [LINE]  # data is the returned result; add LINE to it
        ...
        for x in range(len(dir1)):
            buf = []
            for y in range(len(dir1[x])):
        ...
        data.append(LINE)  # Always have an ending line
        return data
