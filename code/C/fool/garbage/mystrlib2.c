...
void
my_string_cpy(String *strto, char *strfrom)
{
        size_t len;
...
void
my_string_cat(String *strto, char *str1, char *str2)
{
        size_t len1, len2;
        len1 = strlen(str1);
        len2 = strlen(str2) + 1;
...
void
my_string_app(String *str_orig, char *str_to_append)
{
...
void
my_StringObj_cpy(String *strto, String *strfrom)
{
        if (strto->str != NULL)
                free(strto->str);
        if (strfrom->str == NULL)
...
void
my_StringObj_cat(String *strto, String *str1, String *str2)
{
...
void
my_StringObj_app(String *str_orig, String *str_to_append)
{
        if (str_orig->str == NULL) {
...
StringArray
SA_append(StringArray *str_array, char *str)
{
        String tmp = {NULL, 0};
        my_string_cpy(&tmp, str);
...
SA_append_string(StringArray *str_array, String str)
{
        ...
        saferCalloc(new_array.arr, new_array.num, sizeof(String));
        for (i = 0; i < str_array->num; ++i) {
...
void
get_stdin(StringArray *str_array)
{
        int x;
        String buf = {NULL, 0};
...
int
get_all_lines(StringArray *str_array, char *filename)
{
        int ch, it;
        FILE *fp;
